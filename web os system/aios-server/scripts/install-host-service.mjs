...
const label = 'app.lazyoffice.aurion-aios-server';
...
<dict>
  ...
  <key>StandardOutPath</key><string>${xml(path.join(logs, 'aurion-aios-server.stdout.log'))}</string>
  <key>StandardErrorPath</key><string>${xml(path.join(logs, 'aurion-aios-server.stderr.log'))}</string>
</dict>
</plist>
`;
