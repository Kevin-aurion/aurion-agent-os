...
MARKETPLACE_REPOSITORY="Kevin-aurion/aurion-aios-plugin-marketplace"
...
claude plugin uninstall aurion-aios-builder@aurion-aios-plugin-marketplace >/dev/null 2>&1 || true
claude plugin marketplace remove aurion-aios-plugin-marketplace >/dev/null 2>&1 || true
