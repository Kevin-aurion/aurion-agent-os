...
$MarketplaceRepository = "inventra/lazyoffice-aios-plugin-marketplace"
...
try { & claude plugin uninstall lazyoffice-aios-builder@lazyoffice-aios 2>$null } catch { }
try { & claude plugin marketplace remove lazyoffice-aios 2>$null } catch { }
try { & claude plugin uninstall lazyoffice-aios-builder@lazyoffice-aios-plugin-marketplace 2>$null } catch { }
try { & claude plugin marketplace remove lazyoffice-aios-plugin-marketplace 2>$null } catch { }
...
if ($LASTEXITCODE -ne 0) { throw "無法安裝 Lazyoffice AIOS Plugin。" }

Write-Host ""
Write-Host "Lazyoffice AIOS Agent Builder 已安裝完成。" -ForegroundColor Green
