...
- manifest kind: `lazyoffice.aios.agent-package`
- source product: `LazyOffice AIOS`
- JSON Schema id: `https://aios-new.lazyoffice.app/schemas/agent-package-v1.json`
- schema/readme/title/docs: `LazyOffice AIOS Portable Agent Package`
...
In `.scratch/duplicate-agent-cleanup/external-session-idempotency.ts`, remove the obsolete `kevin@aurion-group.com` account fallback; use the LazyOffice account/OWNER lookup without old brand text.
