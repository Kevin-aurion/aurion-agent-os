...
const files = [
  ...
  ['aurion-aios-plugin-updater-macos.zip', path.join(releasesRoot, 'aurion-aios-plugin-updater-macos.zip')],
  ['aurion-aios-plugin-updater-macos-v2.zip', path.join(releasesRoot, 'aurion-aios-plugin-updater-macos-v2.zip')],
  ['aurion-aios-plugin-updater-macos-v3.zip', path.join(releasesRoot, 'aurion-aios-plugin-updater-macos-v3.zip')],
  ['aurion-aios-plugin-updater-macos-v4.zip', path.join(releasesRoot, 'aurion-aios-plugin-updater-macos-v4.zip')],
  ['aurion-aios-plugin-updater-macos-v5.zip', path.join(releasesRoot, 'aurion-aios-plugin-updater-macos-v5.zip')],
  ['aurion-aios-plugin-updater-windows.zip', path.join(releasesRoot, 'aurion-aios-plugin-updater-windows.zip')],
  ['aurion-aios-plugin-updater-windows-v2.zip', path.join(releasesRoot, 'aurion-aios-plugin-updater-windows-v2.zip')],
  ['aurion-aios-plugin-updater-windows-v3.zip', path.join(releasesRoot, 'aurion-aios-plugin-updater-windows-v3.zip')],
  ['aurion-aios-plugin-updater-windows-v4.zip', path.join(releasesRoot, 'aurion-aios-plugin-updater-windows-v4.zip')],
